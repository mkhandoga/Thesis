...
\newacronym{ttva}{TTVA}{Track-to-vertex association}
...
\newacronym{mcp}{MCP}{muon combined performance}
\newacronym{ms}{MS}{Muon Spectrometer}
\newacronym{pf}{PF}{Particle Flow}
\newacronym{hr}{HR}{Hadronic Recoil}
\newacronym{mva}{MVA}{MultiVariate Analysis}
\newacronym{pfo}{PFO}{Particle Flow Object}
\newacronym{pfos}{PFO}{Particle Flow Objects}
\newacronym{npfos}{nPFOs}{Neutral Particle Flow Objects}
\newacronym{cpfos}{cPFOs}{Charged Particle Flow Objects}
