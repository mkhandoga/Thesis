...
\hspace{-1cm}{  Alessandro Viccini, \textit{Professeur, Université de Lefutur,} Rapporteur \par}
\hspace{-1cm}{  Andrew Pilkington, \textit{Professeur, Université de Serenity,} Rapporteur \par}
\hspace{-1cm}{  David Rousseau, \textit{Directeur de recherche, Université de l'Aliance,} Examinateur \par}
\hspace{-1cm}{  Aram Apyan, \textit{Staff researcher, TU Arcturan,} Examinatrice \par}
