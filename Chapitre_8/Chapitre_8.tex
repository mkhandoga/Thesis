...
\end{itemize}
 ...
 The number of the MJ background events is estimated in the following way:
 \begin{itemize}
...
\end{equation}
The shift $\Delta[X]$ applied is assigned a 100\% relative uncertainty because of large statistical uncertainty coming from the linear fit used.
...
\begin{figure}[htbp]
	...
	\includegraphics[width=0.48\textwidth]{plot_ratio_isoslice/PTW_3/CR_2_calib/Wep/lepeta.png}
	\includegraphics[width=0.48\textwidth]{plot_ratio_isoslice/PTW_3/CR_2_calib/Wmup/lepeta.png}\\
