...
//=========  (Tue Oct 23 18:02:09 2018) by ROOT version6.04/16
   ...
   Graph_Graph1001->SetMinimum(37066.7);
   Graph_Graph1001->SetMaximum(40297.16);
   ...
   pfo_mT1002->SetChisquare(4.259379);
   pfo_mT1002->SetNDF(2);
   ...
   pfo_mT1002->SetParameter(0,16.68249);
   pfo_mT1002->SetParError(0,27.82472);
   pfo_mT1002->SetParLimits(0,0,0);
   pfo_mT1002->SetParameter(1,38092.05);
   pfo_mT1002->SetParError(1,806.312);
   ...
   Graph_Graph1003->SetMinimum(36919.81);
   Graph_Graph1003->SetMaximum(40276);
   ...
   pfo_met1004->SetChisquare(3.80594);
   ...
   pfo_met1004->SetParameter(0,32.50986);
   pfo_met1004->SetParError(0,31.00191);
   pfo_met1004->SetParLimits(0,0,0);
   pfo_met1004->SetParameter(1,37876.8);
   pfo_met1004->SetParError(1,889.49);
   ...
   Graph_Graph1005->SetMinimum(33390.46);
   Graph_Graph1005->SetMaximum(37213.39);
   ...
   leppt1006->SetChisquare(0.3622862);
   leppt1006->SetNDF(2);
   ...
   leppt1006->SetParameter(0,-47.61532);
   leppt1006->SetParError(0,37.53573);
   leppt1006->SetParLimits(0,0,0);
   leppt1006->SetParameter(1,36797.98);
   leppt1006->SetParError(1,1221.392);
