...
//=========  (Tue Oct 23 18:02:35 2018) by ROOT version6.04/16
   ...
   Graph_Graph1001->SetMinimum(94078.35);
   Graph_Graph1001->SetMaximum(102722.4);
   ...
   pfo_mT1002->SetChisquare(1.113313);
   pfo_mT1002->SetNDF(2);
   ...
   pfo_mT1002->SetParameter(0,-188.4698);
   pfo_mT1002->SetParError(0,38.30878);
   pfo_mT1002->SetParLimits(0,0,0);
   pfo_mT1002->SetParameter(1,104452.5);
   pfo_mT1002->SetParError(1,1141.124);
   ...
   Graph_Graph1003->SetMinimum(97077.48);
   Graph_Graph1003->SetMaximum(103580.4);
   ...
   pfo_met1004->SetChisquare(1.032481);
   ...
   pfo_met1004->SetParameter(0,-126.2479);
   pfo_met1004->SetParError(0,40.59416);
   pfo_met1004->SetParLimits(0,0,0);
   pfo_met1004->SetParameter(1,104529.8);
   pfo_met1004->SetParError(1,1204.391);
   ...
   Graph_Graph1005->SetMinimum(89446.62);
   Graph_Graph1005->SetMaximum(102284.7);
   ...
   leppt1006->SetChisquare(0.08549115);
   leppt1006->SetNDF(2);
   ...
   leppt1006->SetParameter(0,-280.0312);
   leppt1006->SetParError(0,50.60348);
   leppt1006->SetParLimits(0,0,0);
   leppt1006->SetParameter(1,104456);
   leppt1006->SetParError(1,1600.246);
