...
array_ptW=(20. 25. 30. 100000.)
array_iso=(10. 20. 30. 40.)
len_ptW=${#array_ptW[@]}
len_iso=${#array_iso[@]}
len_ch=${#array_ch[@]}
len_dir=${#array_dir[@]}
...
scan_low: $lbin
scan_high: $hbin
data_iso_veryloose: $samplepath/loose/PTW_2/iso0/$ch/data.root
data_antiiso_veryloose: $samplepath/CR_1_calib/PTW_2/iso$j/$ch/data.root
EW_iso_veryloose: $samplepath/loose/PTW_2/iso0/$ch/ew.root
EW_antiiso_veryloose: $samplepath/CR_1_calib/PTW_2/iso$j/$ch/ew.root
data_iso_SR: $samplepath/sig/PTW_$i/iso0/$ch/data.root
data_antiiso_SR: $samplepath/CR_2_calib/PTW_$i/iso$j/$ch/data.root
EW_iso_SR: $samplepath/sig/PTW_$i/iso0/$ch/ew.root
