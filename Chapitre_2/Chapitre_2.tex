\chapter{The W boson}
    ...
    \end{figure}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=0.5\textwidth,keepaspectratio]{rapidity.png}
			...
			\label{fig::Wrapidity}
		\end{figure}
		Let us consider partonic cross-sections, which can be constructed using an analogy from QED $e^{+}e^{-}\rightarrow \mu^{+}\mu^{-}$ - a flavour-changing process:
		\begin{equation}
